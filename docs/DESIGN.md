...
> Design notes for **property-maintenance-receipt-mailer** — a runnable typescript example that Typed Node service that sends and confirms maintenance receipts with tenant documents and inspection reminders.
...
- **Feature code** — the actual task: property-receipt-email.
